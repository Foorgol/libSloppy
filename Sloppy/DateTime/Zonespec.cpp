...
namespace Sloppy
{
 namespace DateTime
 {
 /** \brief A static string that contains a copy of
 * Boost's standard time zone file
 *
 * Content taken from
 * https://github.com/boostorg/date_time/blob/develop/data/date_time_zonespec.csv
 *
 */
 extern const std::string defaultTzData{R"("Africa/Abidjan","GMT","GMT","","","+00:00:00","+00:00:00","","","","+00:00:00"
